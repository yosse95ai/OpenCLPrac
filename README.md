...
<img src="[https://render.githubusercontent.com/render/math?math=(単純移動平均) = \frac{\sum_{n=0}^{w-1}D_n}{w}](https://render.githubusercontent.com/render/math?math=(SMA)=\frac{\sum_{n=0}^{w-1}D_n}{w})" >
